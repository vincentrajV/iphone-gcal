...
@implementation GoogleCalendarAppDelegate
...
+ (GoogleCalendarAppDelegate *)appDelegate{		// Static accessor
  return (GoogleCalendarAppDelegate *)[[UIApplication sharedApplication] delegate];
}
